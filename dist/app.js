      ...
      route(path, app2) {
        ...
        app2.routes.map((r) => {
          ...
          if (app2.errorHandler === errorHandler) {
            ...
            handler = async (c, next) => (await (0, import_compose.compose)([], app2.errorHandler)(c, () => r.handler(c, next))).res;
...
var require_GeminiClient = __commonJS({
  "utils/GeminiClient.js"(exports2, module2) {
    ...
    async function rotate1psidts(cookies, proxy = null) {
      ...
      if (fs2.existsSync(cacheFile)) {
        const stats = fs2.statSync(cacheFile);
      ...
      if (shouldRotate) {
        try {
          ...
          if (new1psidts) {
            fs2.writeFileSync(cacheFile, new1psidts);
            return new1psidts;
          }
        } catch (error) {
        ...
        try {
          return fs2.readFileSync(cacheFile, "utf8");
        } catch (error) {
    ...
    var GeminiClient2 = class {
      ...
      startAutoRefresh() {
        ...
        console.log(`Starting auto-refresh every ${this.refreshInterval / 1e3} seconds`);
    ...
    module2.exports = GeminiClient2;
  }
});

// utils/error.js
var require_error = __commonJS({
  "utils/error.js"(exports2, module2) {
    function errorResponse2(message, code = 400) {
      const err = new Error(message);
      err.code = code;
      return err;
    }
    module2.exports = errorResponse2;
  }
});

// utils/path-resolve.js
var require_path_resolve = __commonJS({
  "utils/path-resolve.js"(exports2, module2) {
    var path = require("path");
    function resolveFile2(file) {
      return path.join(__dirname, "..", file);
    }
    module2.exports = resolveFile2;
  }
});
...
// config.env.js
var require_config_env = __commonJS({
  "config.env.js"(exports2, module2) {
    var config2 = {};
    if (typeof process !== "undefined" && process.env) {
      const resolveFile2 = require_path_resolve();
      require_main().config({ path: resolveFile2(".env") });
      config2.SECRET_KEY = process.env.SECRET_KEY;
      config2.PORT = process.env.PORT;
    }
  ...
  "handlers/root.js"(exports2, module2) {
    ...
    async function rootHandler(c) {
      if (c.req.method === "GET") {
        ...
        const client2 = c.get("client");
        if (client2 && client2.running) {
    ...
    module2.exports = { rootHandler };
  }
});

// utils/metadata.js
var require_metadata = __commonJS({
  "utils/metadata.js"(exports2, module2) {
    var crypto = require("crypto");
    ...
    module2.exports = { encryptMd, decryptMd, processChatMetadata };
  }
});

// handlers/chat.js
var require_chat = __commonJS({
  "handlers/chat.js"(exports2, module2) {
    var GeminiClient2 = require_GeminiClient();
    var { encryptMd, decryptMd, processChatMetadata } = require_metadata();
    ...
    async function handleChat(c, gemId) {
      ...
      try {
        ...
        if (!message) throw errorResponse2("Message is required", 400);
        let files = [];
        if (file) {
          const tempDir = path.join(__dirname, "..", "temp");
          if (!fs2.existsSync(tempDir)) {
        ...
        if (isNewChat) {
          ...
          const decryptedMetadata = decryptMd(validEncryptedMetadata, config2.SECRET_KEY);
          chat = c.get("client").startChat(decryptedMetadata, gemId);
          response = await chat.send_message(message, files);
        }
        const encryptedMetadata = encryptMd(chat.metadata, config2.SECRET_KEY);
        files.forEach((f) => {
          try {
            fs2.unlinkSync(f);
          } catch (e) {
...
var require_decrypt = __commonJS({
  "handlers/decrypt.js"(exports2, module2) {
      ...
      if (c.req.method === "GET") {
        ...
        try {
          ...
          try {
            ...
            throw errorResponse2("Invalid JSON body", 400);
          }
          const { metadata, token } = body;
          if (!metadata) throw errorResponse2("Query param 'metadata' is required", 400);
          if (!token) throw errorResponse2("Query param 'token' is required", 400);
          let decoded;
          try {
            decoded = jwt2.verify(token, config2.SECRET_KEY);
          } catch {
            throw errorResponse2("Invalid token", 403);
          }
          try {
            const revokedPath = resolveFile2("json/revokeds.json");
            const revokedData = JSON.parse(fs2.readFileSync(revokedPath, "utf-8"));
            if (revokedData.revokeds.includes(token)) throw errorResponse2("Revoked token", 403);
          } catch (err) {
            throw errorResponse2(err.message, 500);
          }
          const decrypted = decryptMd(metadata, config2.SECRET_KEY);
          return c.json({
            decryptedMetadata: {
    ...
    module2.exports = { decryptMdHandler };
  }
});
...
var require_routes = __commonJS({
  "web/routes.js"(exports2, module2) {
    ...
    function setupRoutes2(app2) {
      ...
      app2.get("/decryptmd", decryptMdHandler);
      app2.post("/decryptmd", decryptMdHandler);
      app2.post("/chat", chatHandler);
      app2.post("/chat/:gemId", chatHandler);
    }
    module2.exports = { setupRoutes: setupRoutes2 };
  }
});
...
var fs = require("fs");
var config = require_config_env();
var resolveFile = require_path_resolve();
...
var { secure1psid, secure1psidts } = getCookiesFromFile();
var client = new GeminiClient(secure1psid, secure1psidts);
